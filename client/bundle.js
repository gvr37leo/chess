...
define("AABB", ["require", "exports", "utils"], function (require, exports, Utils) {
    "use strict";
    class AABB {
...
define("ChessBoard", ["require", "exports", "Vector", "utils", "ChessPiece"], function (require, exports, Vector, Utils, ChessPiece) {
    "use strict";
    var Team;
    (function (Team) {
        ...
        draw(ctxt, offset) {
            ...
            this.size.loop((v) => {
                if ((v.x + v.y) % 2 == 0)
                    ...
                    ctxt.fillStyle = "#000";
                if (this.selected && v.equals(this.selected.pos))
                    ctxt.fillStyle = "#0ff";
                if (this.selected && legalsSpots[v.x][v.y])
                    ctxt.fillStyle = "#f00";
...
define("ChessPiece", ["require", "exports", "Vector", "utils", "AABB", "eventHandler"], function (require, exports, Vector, Utils, AABB, EventHandler) {
    "use strict";
    var Team;
    (function (Team) {
        Team[Team["Black"] = 0] = "Black";
...
define("WebIOC", ["require", "exports"], function (require, exports) {
    "use strict";
    class WebIOC {
        constructor(socket) {
            this.socket = socket;
...
define("main", ["require", "exports", "Vector", "utils", "ChessBoard", "AABB", "WebIOC"], function (require, exports, Vector, Utils, ChessBoard, AABB, WebIOC) {
    "use strict";
